...
/** The widest config a shipped method carries: the passkey's `abi.encode(uint256 x, uint256 y, bytes32 rpIdHash)`. */
 ...
 * each in its own clause with the widest config and a supplied salt; `sealBackup` refuses any other size.
 */
